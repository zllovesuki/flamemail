...
export class MockWebSocket extends EventTarget implements WebSocket {
  static readonly CONNECTING: WebSocket["CONNECTING"] = 0;
  static readonly OPEN: WebSocket["OPEN"] = 1;
  static readonly CLOSING: WebSocket["CLOSING"] = 2;
  static readonly CLOSED: WebSocket["CLOSED"] = 3;
  ...
  protocol = "";
  readonly url: string;
  private currentReadyState: WebSocketReadyState = MockWebSocket.CONNECTING;
