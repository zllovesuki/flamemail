      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        {inboxes.map((inbox) => (
          ...
          >
            ...
            <span className="mt-0.5 block text-xs text-zinc-400">{inbox.domain}</span>
            <small className="mt-1 block truncate font-mono text-xs text-zinc-500">{inbox.address}</small>
          </Link>
        ))}
      </div>
    </Card>
